...
import 'package:binance_future_trades_budget_planner/src/command_runner.dart';
...
void main() {
  group('BinanceFutureTradesBudgetPlannerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late BinanceFutureTradesBudgetPlannerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = BinanceFutureTradesBudgetPlannerCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = BinanceFutureTradesBudgetPlannerCommandRunner();
